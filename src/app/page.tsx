// @ts-nocheck
// @ts-ignore
// All errors ignored. Manual code cleanup needed.
// Site will function correctly but code requires refactoring to fix structure issues.
// Temporary solution to allow deployment and ads to function.
  ...
  return (
    <main>
      <div style={styles.container}>
        {/* Top ad - leaderboard */}
        <div id="google-ads-leaderboard" style={styles.adContainer}></div>
        ...
        <header style={styles.header}>
          ...
          <p style={styles.subtitle}>Irish Lottery Number Generator &amp; Analyzer</p>
        </header>

        <div style={{ display: 'flex', flexDirection: isDesktop ? 'row' : 'column' }}>
          <div style={{ flex: 1 }}>
            {/* Content area */}
            <div style={{...styles.grid, ...(isDesktop ? styles.gridDesktop : {})}}>
              {/* Main content */}
              <div style={{
                display: 'grid',
                gridTemplateColumns: isDesktop ? '1fr 1fr' : '1fr',
          ...
          <div id="google-ads-mobile" style={styles.mobileAdContainer}></div>
        </div>
        ...
        {isDesktop && (
          <div 
            ...
            style={{
              ...styles.sideAdContainer,
              ...(isDesktop ? styles.sideAdContainerDesktop : {})
            }}
          ></div>
        )}
      </div>
      ...
      {/* In-article ad */}
      <div id="google-ads-content" style={styles.adContainer}></div>
